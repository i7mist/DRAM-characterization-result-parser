...
if args["trace_type"] == 'CPU':
  R_dataframe_out_f.write_to_all(["MPKI", "ipc", "weighted_speedup", "locality", "bandwidth_utilization", "bandwidth", "average_latency_ns", "normalized_ipc", "normalized_weighted_speedup", "average_outstanding_requests", "average_power", "power", "power_breakdown", "energy_breakdown", "normalized_total_energy", "effective_BLP", "LLC_miss_rate"], ",".join(["statistics", "value", "DRAM", "workload", "workload_feature", "workload_and_feature", "ref_MPKI"]) + "\n")
elif args["trace_type"] == 'DRAM':
  R_dataframe_out_f.write_to_all(["locality", "bandwidth_utilization", "average_latency_ns", "normalized_bandwidth", "bandwidth", "average_outstanding_requests", "power", "power_breakdown", "energy_breakdown", "normalized_total_energy", "effective_BLP", "LLC_miss_rate"], ",".join(["statistics", "value", "DRAM", "workload", "workload_feature", "workload_and_feature", "ref_memory_intensity"]) + "\n")
else: assert(False)
...
#     w.append_2D_to(["act_power", "pre_power", "read_power", "write_power", "act_stdby_power", "pre_stdby_power", "ref_power", "io_term_power"], out_f["power_breakdown"])
#     w.append_2D_to(["act_energy", "pre_energy", "read_energy", "write_energy", "act_stdby_energy", "pre_stdby_energy", "ref_energy", "io_term_energy"], out_f["energy_breakdown"])
#     w.append_2D_to(["average_power"], out_f["power"])
    w.append_2D_to(["normalized_total_energy"], out_f["normalized_total_energy"])
    w.append_2D_to(["effective_BLP"], out_f["effective_BLP"])
    w.append_2D_to(["LLC_miss_rate"], out_f["LLC_miss_rate"])
...
#     w.append_1D_to(["act_power", "pre_power", "read_power", "write_power", "act_stdby_power", "pre_stdby_power", "ref_power", "io_term_power"], R_dataframe_out_f["power_breakdown"])
#     w.append_1D_to(["act_energy", "pre_energy", "read_energy", "write_energy", "act_stdby_energy", "pre_stdby_energy", "ref_energy", "io_term_energy"], R_dataframe_out_f["energy_breakdown"])
#     w.append_1D_to(["average_power"], R_dataframe_out_f["power"])
    w.append_1D_to(["normalized_total_energy"], R_dataframe_out_f["normalized_total_energy"])
    w.append_1D_to(["effective_BLP"], R_dataframe_out_f["effective_BLP"])
    w.append_1D_to(["LLC_miss_rate"], R_dataframe_out_f["LLC_miss_rate"])
    if single_threaded_workload_lists is None:
