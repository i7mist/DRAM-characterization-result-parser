...
class workload_stats(object):
  ...
  def __init__(self, configs):
    ...
    if self.ref_stats is None:
      if self.single_threaded_workload_list is None:
        self.ref_stats = sa.Stats(self.workload_dir + "/" + self.workload + "/" + self.ref_DRAM + ".stats")
      else:
        self.ref_stats = sa.Stats(self.workload_dir + "/" + self.workload + "/" + self.ref_DRAM + ".stats", [self.workload_dir + "/" + workload_name + "/" + self.ref_DRAM + ".stats" for workload_name in self.single_threaded_workload_list])
